...
export async function POST(request: Request) {
  try {
    console.log('Starting create_product request');
    ...
    try {
      console.log('Calling API endpoint:', `${API_BASE_URL}/seller/create_product`);
      const response = await axios.post(
        `${API_BASE_URL}/seller/create_product`, // Remove /api prefix
        formattedBody,
        { 
          headers,
